...
return [
    ...
    'home' => [
        'page-title' => 'E-commerce Logistics Link - Home',
        'featured-products' => 'Featured Options',
    ...
    'header' => [
        'title' => 'Account',
        'dropdown-text' => 'Manage Account, Bookings, etc.',
        'sign-in' => 'Sign In',
        'sign-up' => 'Sign Up',
        'account' => 'Account',
        'cart' => 'List of Bookings',
        'profile' => 'Profile',
        // 'wishlist' => 'Wishlist',
        'cart' => 'List of Bookings',
        'logout' => 'Logout',
        'search-text' => 'Search booking options here'
    ],

    'minicart' => [
        'view-cart' => 'View packages for booking',
        'checkout' => 'Checkout',
    ...
    'subscription' => [
        ...
        'unsubscribed' => 'You Are Unsubscribed From E-commerce Logistics Link Subscription Mails',
    ...
    'search' => [
        ...
        'page-title' => 'E-commerce Logistics Link - Search',
    ...
    'customer' => [
        ...
        'signup-form' => [
            ...
            'dont-have-account' => 'You Do Not Have An Account With Us',
        ],
        ...
        'login-form' => [
            ...
            'footer' => '© Copyright 2018 Connectech, All rights reserved',
    ...
    'webkul' => [
        'copy-right' => '© Copyright 2018 Connectech, All rights reserved'
    ],
